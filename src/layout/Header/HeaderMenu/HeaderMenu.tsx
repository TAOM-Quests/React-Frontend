...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 22, label: 'Кафедра связей с общественностью', path: '/games/2' },
      { id: 23, label: 'Кафедра экономики и финансов', path: '/games/3' },
      { id: 24, label: 'Кафедра управления', path: '/games/4' },
      { id: 25, label: 'Кафедра дизайна', path: '/games/5' },
    ],
  },
