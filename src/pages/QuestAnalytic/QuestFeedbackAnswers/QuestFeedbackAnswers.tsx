...
import './QuestFeedbackAnswers.scss'
...
interface QuestFeedbackAnswersProps {
  analyticData: QuestAnalyticElementProps
  feedbackForm?: FeedbackForm
}

export const QuestFeedbackAnswers = ({
  feedbackForm,
  analyticData,
}: QuestFeedbackAnswersProps) => {
  const table =
  ...
  return (
    <div className="container_min_width quest-FeedbackAnswers">
      <div className="quest-FeedbackAnswers__header">
