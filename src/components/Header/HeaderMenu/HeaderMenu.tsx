...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 22, label: 'Кафедра связей с общественностью', path: '/quest/2' },
      { id: 23, label: 'Кафедра экономики и финансов', path: '/quest/3' },
      { id: 24, label: 'Кафедра управления', path: '/quest/4' },
      { id: 25, label: 'Кафедра дизайна', path: '/quest/5' },
    ],
  },
